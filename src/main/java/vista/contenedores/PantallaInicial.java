...
public class PantallaInicial extends VBox {
    ...
    public PantallaInicial(Stage ventana, Scene menu){
        ...
        Image imagen = new Image("file:src/main/java/vista/imagenes/algoChessV3.png", ProveedorConstantes.getAnchoVentana(), ProveedorConstantes.getAltoVentana(), false, true, true);
        ...
        botonComenzarElJuego.setTranslateX(ProveedorConstantes.getAnchoVentana() - anchoBoton);
        botonComenzarElJuego.setTranslateY(ProveedorConstantes.getAltoVentana() - altoBoton);
