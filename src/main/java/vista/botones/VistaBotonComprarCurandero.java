...
public class VistaBotonComprarCurandero {

    static int BOTON_ANCHO = 300;
    static int BOTON_ALTO = 100;

    public VistaBotonComprarCurandero(Button botonComenzarElJuego){
        botonComenzarElJuego.setMaxSize(BOTON_ANCHO, BOTON_ALTO);
        botonComenzarElJuego.setMinSize(BOTON_ANCHO, BOTON_ALTO);
        Image comenzar = new Image("file:src/main/java/vista/imagenes/curanderoRandom.png",
