...
public class ProveedorConstantes {
    ...
    public static int costoSoldado() { return COSTO_SOLDADO; }
    public static int costoJinete() { return COSTO_JINETE; }
    public static int costoCurandero() { return COSTO_CURANDERO; }
    public static int costoCatapulta() { return COSTO_CATAPULTA; }
}
